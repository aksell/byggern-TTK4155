...
#define TWI_BUFFER_SIZE                                                        \
  3 // Set this to the largest message size that will be sent including address
    // byte.
...
#define TWI_STX_ADR_ACK_M_ARB_LOST                                             \
  0xB0 // Arbitration lost in SLA+R/W as Master; own SLA+R has been received;
...
#define TWI_STX_DATA_ACK_LAST_BYTE                                             \
  0xC8 // Last data byte in TWDR has been transmitted (TWEA = “0”); ACK has been
       // received
...
#define TWI_SRX_ADR_ACK_M_ARB_LOST                                             \
  0x68 // Arbitration lost in SLA+R/W as Master; own SLA+W has been received;
       // ACK has been returned
#define TWI_SRX_GEN_ACK                                                        \
  0x70 // General call address has been received; ACK has been returned
#define TWI_SRX_GEN_ACK_M_ARB_LOST                                             \
  0x78 // Arbitration lost in SLA+R/W as Master; General call address has been
       // received; ACK has been returned
#define TWI_SRX_ADR_DATA_ACK                                                   \
  0x80 // Previously addressed with own SLA+W; data has been received; ACK has
       // been returned
#define TWI_SRX_ADR_DATA_NACK                                                  \
  0x88 // Previously addressed with own SLA+W; data has been received; NOT ACK
       // has been returned
#define TWI_SRX_GEN_DATA_ACK                                                   \
  0x90 // Previously addressed with general call; data has been received; ACK
       // has been returned
#define TWI_SRX_GEN_DATA_NACK                                                  \
  0x98 // Previously addressed with general call; data has been received; NOT
       // ACK has been returned
#define TWI_SRX_STOP_RESTART                                                   \
  0xA0 // A STOP condition or repeated START condition has been received while
