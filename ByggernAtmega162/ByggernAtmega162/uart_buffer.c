...
bool uart_buffer_full() { return uart_buffer_full_var; }

void uart_buffer_set_full() { uart_buffer_full_var = true; }
...
bool uart_buffer_empty() { return uart_buffer_empty_var; }
