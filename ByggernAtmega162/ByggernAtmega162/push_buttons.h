...
// Returns true if the pushbutton has been pushed down since last call of
// push_buttons_get_state
bool push_buttons_get_state(push_button_t button);

// Read the value of the push button ports and  updates the states of the push
// button
