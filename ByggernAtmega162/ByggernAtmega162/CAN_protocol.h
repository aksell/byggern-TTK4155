...
#define CAN_GAME_OVER_ACK                                                      \
  1 // Acknowledge that node 2 has changed out of game mode

#define CAN_START_GAME                                                         \
  4 // Message sent from node 1 indicating that a game is stating
#define CAN_START_GAME_ACK 3 // Acknowledge that node 2 has reacted to
                             // START_GAME
...
#define CAN_SOLANOIDE_TRIGGER_MS                                               \
  14 // Request node 2 to activate solenoid together with two bytes of data
     // indicating the ms of activation
...
// Music messages
#define CAN_START_MUSIC                                                        \
  20 // Request a start of music in node 2 with value of 1 byte of music_t from
     // "music.h"
#define CAN_START_MUSIC_LOOP                                                   \
  21 // Request a start of music played in loop in node 2 with value of 1 byte
     // of music_t from "music.h"
