...
void oled_set_value_range(uint8_t page, uint8_t start, uint8_t end,
                          uint8_t val);
...
// Maps printf to oled
static FILE oled_stream =
    FDEV_SETUP_STREAM(oled_print_char, NULL, _FDEV_SETUP_WRITE);

static FILE oled_big_stream =
    FDEV_SETUP_STREAM(oled_print_char_big, NULL, _FDEV_SETUP_WRITE);
