...
// As master sends an array send_data of uint8_t of length data_lenth and
// records received values on the array recived_data
void spi_transmit_recieve(uint8_t *send_data, uint8_t *recieve_data,
                          uint8_t data_length);
