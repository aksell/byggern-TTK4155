...
void score_start_counting() { timer0_enable(); }

void score_stop_counting() { timer0_dissable(); }

void score_set(uint8_t score) { score_count = score; }
...
uint8_t score_get() { return score_count; }

bool score_is_screen_outdated() { return score_screen_outdated; }
